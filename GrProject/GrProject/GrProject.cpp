...
int flag = 0;
int var;
bool save, load, lineParametric, LineClipping, PointClipping, directCircle, polarCircle, interactiveCircle, midpointCircle, modifiedCircle,
lineDDA, lineMidPoint, midpointline, EllipsePolar, EllipseDirect, red, green, blue;
